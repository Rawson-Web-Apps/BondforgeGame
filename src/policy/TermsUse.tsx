...
const TermsUse = () => {
  return (
    <div className="terms-use">
      ...
      <p>
        We are Rawson Web Apps LLC ("Company," "we," "us," "our"). We operate
        tarawson.com, as well as any other related products and services that
        refer or link to these legal terms (the "Legal Terms") (collectively,
        the "Services").
      </p>
      <p>You can contact us by email at rawsonwebapps@gmail.com</p>
      <p>
        These Legal Terms constitute a legally binding agreement made between
        you, whether personally or on behalf of an entity ("you"), and Rawson
        Web Apps LLC, concerning your access to and use of the Services.
      </p>
      ...
      <p>
        ...
        address your request to: rawsonwebapps@gmail.com.
      </p>
      <p>
      ...
      <p>
        ...
        Utah. You irrevocably consent that the courts of Utah shall have
      ...
      <p>
        ...
        be 1. The seat, or legal place, of arbitration shall be Utah. The
        language of the proceedings shall be English. The governing law of these
        Legal Terms shall be substantive law of Utah.
      </p>
      ...
      <p>
        ...
        PAID, IF ANY, BY YOU TO US OR $10. CERTAIN US STATE LAWS AND
      ...
      <p>Rawson Web Apps LLC</p>
      <p>Email: rawsonwebapps@gmail.com</p>
    </div>
  );
};
